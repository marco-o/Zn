...
namespace zn
{
	...
	public:
		...
		quadratic_sieve0_t(const large_int &n, small_int base_size) : n_(n)
		{
		...
		large_int sieve(void)
		{
			...
			{
				threads_.emplace_back(&quadratic_sieve0_t::sieving_thread, this);
	...
	large_int quadratic_sieve0(const large_int &n, small_int base_size)
	{
#if DBG_SIEVE >= DBG_SIEVE_INFO
		std::cout << "Factorization of " << n << std::endl;
#endif
		quadratic_sieve0_t<large_int, small_int, real> qs(n, base_size);
		return qs.sieve();
	}
